...
function construirEntorno({ latenciaMs = 30 } = {}) {
  ...
  const sandbox = {
    ...
    _normalizedHouseTypesLoaded: false,
    _normalizedTransactionsLoaded: false,
    _normalizedProjectCollectionsLoaded: false,
    _normalizedSubcontractingLoaded: false,
    _normalizedGlobalCatalogsLoaded: false,
    _syncNormalizedProjectsHouses: async () => true,
    _syncNormalizedSubcontractorUpserts: async () => true,
    _syncNormalizedSubcontractorAdvances: async () => true,
    _syncDeletedSubcontractors: async () => true,
    _syncNormalizedActivity: async () => true,
    _syncNormalizedDocuments: async () => true,
    _syncNormalizedHouseTypes: async () => true,
    _syncNormalizedTransactions: async () => true,
    _syncNormalizedProjectCollections: async () => true,
    _syncNormalizedSubcontracting: async () => true,
    _syncNormalizedGlobalCatalogs: async () => true,
